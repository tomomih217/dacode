...
function exolpodeGroup (x, y, trans) {
  ...
  $container.className = 'explode-container';
...
function sparcle() {
  ...
  explosions.push( exolpodeGroup(x, y, {scale: .5, x: -30, y: -50, r: 180}) );
  explosions.push( exolpodeGroup(x, y, {scale: .5, x: -50, y: -20, r: -90}) );
